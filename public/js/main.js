...
;(function(global, document, BUILD, $, d3, Handlebars){
    ...
    function cargamosHash(){
        for (var i = 0; i < candi.length; i++) {
                        ...
                        info += '<div class="bio"><div class="edad"><span>Edad: </span>'+canDatos[+candi[i]-1].edad+'</div><div class="profesion"><span>Profesión: </span>'+canDatos[+candi[i]-1].profesion+'</div><div class="web"><span></span>';
    ...
    function cargamos(){
            ...
            for (var i = 1; i < 6; i++) {
                    ...
                    if( $("#tarj"+[i]).hasClass( "cargada" ) || pasa == 1 ){
                        ...
                        info += '<div class="bio"><div class="edad"><span>Edad: </span>'+canDatos[(idf-1)].edad+'</div><div class="profesion"><span>Profesión: </span>'+canDatos[(idf-1)].profesion+'</div><div class="web"><span></span>';
